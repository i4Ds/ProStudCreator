        ...
        <ContentTemplate>
            ...
            <table class="gradingV1Overview">
                <tr>
                    ...
                    <td><asp:Label runat="server" ID="lblStudent" /></td>
                </tr>
                <tr>
                    <td>Projekttitel:</td>
                    <td style="height: 3em;"><asp:Label runat="server" ID="lblProjectTitle" /></td>
                </tr>
                <tr>
                    <td>Betreuender Dozent:</td>
                    <td><asp:Label runat="server" ID="lblAdvisor" /></td>
                </tr>
                <tr>
                    <td>Experte:</td>
                    <td><asp:Label runat="server" ID="lblExpert" /></td>
                </tr>
            </table>
        ...
        <ContentTemplate>
            ...
            <table class="gradingV1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtAStrategyWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtAStrategy" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtAStrategyComment"></asp:TextBox></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtAProjectSummaryContentsWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtAProjectSummaryContents" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtAProjectSummaryContentsComment"></asp:TextBox></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtAProjectSummaryPlanningWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtAProjectSummaryPlanning" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtAProjectSummaryPlanningComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtBTheoreticalWorkWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtBTheoreticalWork" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtBTheoreticalWorkComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>2.2</td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtBPracticalWorkWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtBPracticalWork" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtBPracticalWorkComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>2.3</td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtBEvaluationWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtBEvaluation" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtBEvaluationComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>2.4</td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtBResultsWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtBResults" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtBResultsComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>2.5</td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtBAutonomyWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtBAutonomy" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtBAutonomyComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtCDocumentationWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtCDocumentation" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtCDocumentationComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>3.2</td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtCDefenseWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtCDefense" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtCDefenseComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>3.3</td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtCPresentationsWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtCPresentations" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtCPresentationsComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
                    ...
                    <td class="sectionSummaryCell centered">
                        <asp:Label runat="server" ID="lblGrade3"></asp:Label></td>
                    <td></td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtDCollaborationInternalWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtDCollaborationInternal" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtDCollaborationInternalComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>4.2</td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtDCollaborationExternalWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtDCollaborationExternal" CssClass="form-control"></asp:TextBox></td>
                    <td class="small">Eine gute Zusammenarbeit und Kommunikation beinhaltet die Einladung zu Sitzung mit Traktandenlisten, das Führen eines Sitzungsprotokolls mit Dokumentation der wichtigen Beschlüsse, das kommentierte Nachbessern von Zeitplänen sowie die Aktivierung von internem Wissen. Der/die Studierende setzte dies in folgendem Masse um:<br />
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtDCollaborationExternalComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>4.3</td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="0.5" max="2" step="0.5" ID="txtDMotivationWeight" CssClass="form-control"></asp:TextBox></td>
                    <td>
                        <asp:TextBox runat="server" TextMode="Number" min="1" max="6" step="0.1" ID="txtDMotivation" CssClass="form-control"></asp:TextBox></td>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtDMotivationComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
                    ...
                    <td class="sectionSummaryCell centered">1</td>
                    <td class="sectionSummaryCell centered">
                        <asp:Label runat="server" ID="lblGrade4"></asp:Label></td>
                    <td></td>
                    <td></td>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td style="font-weight: bold;" colspan="2" class="bonusCell centered">
                        <asp:Label runat="server" ID="lblGradePreBonus"></asp:Label></td>
                    <td></td>
                    <td></td>
                    <td></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtENewTopicComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtEDifficultyComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td class="name">
                    ...
                    <td>
                        <asp:TextBox runat="server" TextMode="MultiLine" Columns="50" Rows="6" ID="txtEEnvironmentComment"></asp:TextBox></td>
                </tr>
                <tr>
                    <td></td>
                    <td class="bonusCell">
                    ...
                    <td class="bonusCell" colspan="2">
                        <asp:TextBox runat="server" TextMode="Number" min="0" max="0.2" step="0.1" ID="txtEBonus" CssClass="form-control"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td style="text-align: center" colspan="2" class="finalCell">
                        <asp:Label runat="server" ID="lblGradeTotal"></asp:Label></td>
                    <td></td>
                    <td></td>
                </tr>
